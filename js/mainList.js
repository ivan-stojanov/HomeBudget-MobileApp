...
//this part is to add items in the account objectStore (when app is first Installed)
		const objExpenses = [
			...
			{ expenseName: "Laptops", expenseCategory: "Bill", expenseAmmount: "400", expenseDueDate: "12/12/2014/23/59", expenseAccount: "Niko", expenseRepeat: "yes", expenseRepeatCycle: "Weekly", expenseBillPaid: "paidNoo", expenseRepeatEndDate: "12/12/2014/23/59", expenseRepeatLastUpdate: today, expenseCreated: today, expenseNumItems: "1" },
		];	
													//alert("created objects onupgradeneeded");
